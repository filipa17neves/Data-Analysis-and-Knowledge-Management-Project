...
**Random Forest** was selected as the best classifier. The confusion matrix below shows strong diagonal performance across all four HDI classes (Low / Medium / High / Very High).

![Random Forest Confusion Matrix HDI](rf_confusion_matrix_hdi.png)

The most important predictors for HDI classification were literacy rate (SC_SEC_LET_2020) and years of schooling (SC_SEC_SYT_2020), which together dominate the model's decisions.

![Random Forest Feature Importance HDI](rf_feature_importance_hdi.png)

## Key Findings

- GDP and HDI are strongly positively correlated
